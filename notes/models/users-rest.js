...
let connectREST = function () {
    return new Promise((resolve, reject) => {
      ...
      .then(client => {
          client.basicAuth('users-admin', 'D3ED43C0-VD43-DSD3-3D2O-3DFE0B3AEF');
